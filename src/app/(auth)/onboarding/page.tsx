...
export default async function OnboardingPage() {
    ...
    return (
      <div className="w-full max-w-md space-y-8 text-center">
        ...
        <form action={completeOnboarding} className="space-y-4 text-left">
          ...
          <button
            type="submit"
            className="w-full rounded-[8px] bg-ink px-5 py-2 text-sm font-medium text-canvas transition-all duration-200 hover:-translate-y-px hover:opacity-90 cursor-pointer"
          >
            Continue
          </button>
        </form>
  ...
  return (
    <div className="w-full max-w-md space-y-8 text-center">
      <div className="space-y-2">
        <h1 className="font-display text-2xl text-ink">How will you use Instant/Creator?</h1>
