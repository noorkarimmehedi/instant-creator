...
export default function AuthLayout({
  ...
  return (
    <div className="auth-page relative flex min-h-screen items-center justify-center bg-canvas px-4">
      ...
      <div className="relative rounded-[12px] border border-hairline-strong p-3 animate-[fade-up_0.6s_ease-out_both]">
        ...
        <div className="animate-[fade-up_0.6s_ease-out_0.1s_both]">{children}</div>
      </div>
    </div>
  );
}
